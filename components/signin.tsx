            ...
            >
                <div className="flex flex-col gap-12">
                    <div className="flex flex-col text-center gap-2">
                        <h2 className="font-semibold text-3xl md:text-4xl tracking-tighter text-richblack-500 flex gap-2">
                            <UnderLine> Welcome to{" "}
                        ...
                        <p className="text-primary/75 font-medium tracking-tighter text-base md:text-lg text-yellow-5 font-mono">
